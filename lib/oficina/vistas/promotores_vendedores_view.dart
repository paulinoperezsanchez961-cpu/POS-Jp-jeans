    ...
    pw.Widget construirBloqueRecibo(String tipoCopia) {
      return pw.Column(
        ...
        children: [
          ...
          // 🚨 PARCHE LINTER: Se eliminó el const
          pw.Text(
            tipoCopia,
          ...
          pw.Row(
            ...
            children: [
              pw.Text('Promotor:', style: pw.TextStyle(fontSize: 8)),
              pw.Text(
                nombre.toUpperCase(),
                style: pw.TextStyle(
                  fontSize: 8,
          ...
          pw.Row(
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
              pw.Text('Código:', style: pw.TextStyle(fontSize: 8)),
              pw.Text(codigo, style: pw.TextStyle(fontSize: 8)),
            ],
          ),
          pw.Row(
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
              pw.Text('Piezas Pagadas:', style: pw.TextStyle(fontSize: 8)),
              pw.Text('$piezas pzs', style: pw.TextStyle(fontSize: 8)),
            ],
          ),
          pw.Divider(borderStyle: pw.BorderStyle.dashed),
          pw.Row(
          ...
          pw.Text('Firma Recibido:', style: pw.TextStyle(fontSize: 8)),
          pw.SizedBox(height: 15),
          pw.Text(
