  ...
  Future<void> _eliminarProductoReal(int idProducto) async {
    bool? confirmar = await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Se borrará del sistema y dejará de aparecer en el mostrador y en la tienda web.',
        ),
        actions: [
          TextButton(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final String fotoUrl =
                                (prod['url_foto_principal'] ?? '').isNotEmpty
                                ? 'https://api.jpjeansvip.com${prod['url_foto_principal']}'
